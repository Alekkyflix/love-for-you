      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="p-8 md:p-12 border-rose/20 bg-card/90 backdrop-blur-sm shadow-[0_20px_60px_-10px_hsl(340_75%_55%_/_0.2)] animate-fade-in">
          <div className="relative">
            ...
            <div className="space-y-6 text-lg leading-relaxed text-muted-foreground">
              <p className="text-2xl text-rose font-semibold mb-8">My pookie patootie bear 🥺❤️, </p>
        ...
        <div className="text-center mt-12">
          <div className="flex justify-center items-center gap-2 text-muted-foreground">
            ...
            <span className="text-lg">Happy Girlfriend's Day, Miss Bisieri!</span>
